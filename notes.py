...
notes_entry = Text(window, width=50, height=7)
notes_entry.place(x=80, y=90)

# Perform notes functions
button1 = Button(window, text='Add Notes', bg='#FFE4C4', fg='Red', command=add_notes, width=10).place(x=30, y=240)
button2 = Button(window, text='View Notes', bg='#FFE4C4', fg='Red', command=view_notes, width=10).place(x=150, y=240)
button3 = Button(window, text='Delete Notes', bg='#FFE4C4', fg='Red', command=delete_notes, width=10).place(x=270, y=240)
button4 = Button(window, text='Update Notes', bg='#FFE4C4', fg='Red', command=update_notes, width=10).place(x=385, y=240)
